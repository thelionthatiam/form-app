...
app.get('/', function (req, res) {
  res.render('index', {title: 'Money', subtitle:'yourface'});
})
...
app.post('/submit', function(req, res, next) {
  ...
  res.render('index', {title: 'Money', subtitle:'yourface', emailMessage: email, phoneMessage: phone});
})
...
app.post('/', function(req, res, next) {
  ...
  basicQuery(text, values, (err, result) => {
    ...
    if (err) {
      ...
      res.render('index', {title: 'Money', subtitle:'yourface', phoneMessage: err});
    } else {
